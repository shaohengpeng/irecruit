                    ...
                    <el-card class="box-card my-box-card" shadow="hover">
                        <div slot="header" class="clearfix my-el-card_head">
                            ...
                            <el-dropdown-menu slot="dropdown">
                                ...
                                <el-dropdown-item @click.native="passsuccess(index)">审核通过</el-dropdown-item>
                                <el-dropdown-item @click.native="passfail(index)">审核未通过</el-dropdown-item>
                                <el-dropdown-item @click.native="updaterecruit(index)">兼职查看</el-dropdown-item>
                            </el-dropdown-menu>
                            </el-dropdown>
                        </div>
                        <div class="text item">
...
export default {
    ...
    methods:{
        ...
        passsuccess:function(index){
            this.updaterecruitinfo.positionid = this.recruitinfos[index].positionid;
            this.updaterecruitinfo.checkstatus = '审核通过';
            this.$http.post('http://localhost:8080/updaterecruitinfoBypositionid',this.updaterecruitinfo).then((Response)=>{
                if(Response.data.code===200){
                    this.$message('兼职审核通过');
                }
        ...
        passfail:function(index){
            this.updaterecruitinfo.positionid = this.recruitinfos[index].positionid;
            this.updaterecruitinfo.checkstatus = '审核未通过';
            this.$http.post('http://localhost:8080/updaterecruitinfoBypositionid',this.updaterecruitinfo).then((Response)=>{
                if(Response.data.code===200){
                    this.$message('兼职审核未通过');
                }
            })
        },
